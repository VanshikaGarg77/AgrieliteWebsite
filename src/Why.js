const Why = () => {
    return (  
        <div id="why">
         <h1 className="h-why">WHY US?</h1>
        <div className="Why">
         <div className="row"> 
             <h4 className="col-md-4"> 
             <h1 className="the">Our Competitive Edge</h1>
         <br/>
            We are the only one who are providing Mini-Mini E-tractor .<br/>
             There is no  competition in the market .<br/>
            We offer the only fully electric tractor on the market, with advanced features
